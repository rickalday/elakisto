...
<?php
	...
	$featured_img = wp_get_attachment_image_src( get_post_thumbnail_id( $id ), 'elakisto-single-post' );
	?>
	<div id="portfolio-gallery-<?php echo esc_attr( $id ) ?>" class="porffolio-gallery text-post large-title">
		<div class="header"><h2><a href="<?php echo esc_attr( $post_permalink ) ?>" data-title="<?php echo esc_attr( $title ) ?>" data-featured="<?php echo $featured_img[0] ?>"><span><?php echo esc_attr( $title ) ?></span></a></h2></div>
